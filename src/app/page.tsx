  ...
  return (
    <div className="min-h-screen bg-[#07080f] text-white flex flex-col relative overflow-hidden">
      ...
      <header className="relative z-10 flex items-center justify-between px-6 py-3.5">
        ...
        <Link
          href="/login"
          className="text-xs font-semibold text-[#8892a4] hover:text-white transition-colors border border-[#2a2f4a] hover:border-[#b45309]/50 px-3 py-1.5 rounded-lg"
        >
          Login
        </Link>
      </header>
      ...
      <main className="relative z-10 flex-1 flex flex-col items-center justify-center px-6 text-center">
        ...
        {/* Badge */}
        <div className="inline-flex items-center gap-1.5 border border-[#b45309]/20 bg-[#b45309]/5 px-3 py-1 rounded-full mb-4">
          <Zap size={10} className="text-[#d97706]" />
          <span className="text-[10px] font-medium text-[#d97706]/80 tracking-wide">Zero wait. Zero hassle.</span>
        </div>

        {/* Logo icon — floating */}
        <div className="relative mb-4 animate-float">
          <div className="absolute inset-0 rounded-2xl bg-[#b45309]/20 blur-xl scale-125" />
          <div className="relative w-16 h-16 bg-gradient-to-br from-[#1a1408] via-[#0d0f1a] to-[#07080f] rounded-2xl flex items-center justify-center shadow-xl shadow-[#b45309]/15 border border-[#f59e0b]/10">
            <svg width="52" height="52" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="2" y="2" width="13" height="13" rx="3" fill="url(#hg1)" />
              <rect x="5" y="5" width="7" height="7" rx="1.5" fill="#07080f" />
              <rect x="25" y="2" width="13" height="13" rx="3" fill="url(#hg1)" />
              <rect x="28" y="5" width="7" height="7" rx="1.5" fill="#07080f" />
              <rect x="2" y="25" width="13" height="13" rx="3" fill="url(#hg1)" />
              <rect x="5" y="28" width="7" height="7" rx="1.5" fill="#07080f" />
              ...
              <path d="M22 15 L17 22 H20.5 L18 28 L24 20 H20.5 Z" fill="url(#hg2)" />
              <defs>
                <linearGradient id="hg1" x1="0" y1="0" x2="1" y2="1" gradientUnits="objectBoundingBox">
                  <stop offset="0%" stopColor="#f59e0b" />
                  <stop offset="100%" stopColor="#b45309" />
                </linearGradient>
                <linearGradient id="hg2" x1="0" y1="0" x2="0" y2="1" gradientUnits="objectBoundingBox">
                  <stop offset="0%" stopColor="#fde68a" />
                  <stop offset="100%" stopColor="#d97706" />
                </linearGradient>
              </defs>
        ...
        {/* Headline */}
        <h1 className="text-4xl sm:text-5xl font-extrabold tracking-tighter leading-[1.05] mb-3">
          Order from your{" "}
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#d97706] to-[#92400e]">
            table.
          </span>
        </h1>
        <p className="text-[#8892a4] text-sm sm:text-base leading-relaxed max-w-sm mb-8">
        ...
        <div className="w-full max-w-2xl grid grid-cols-1 sm:grid-cols-3 gap-3 mb-8">
          {steps.map((step, i) => (
            <div
              key={step.num}
              className="relative group text-left p-4 rounded-xl border border-[#1e2235] bg-[#0d0f1a]/80 backdrop-blur-sm overflow-hidden"
            >
              ...
              <span className="absolute top-2 right-3 text-4xl font-black text-white/[0.04] select-none leading-none">
                {step.num}
              </span>
              <div className="w-8 h-8 rounded-lg bg-[#b45309]/8 border border-[#b45309]/12 flex items-center justify-center text-[#c2610c] mb-3">
                {step.icon}
              </div>
              <p className="text-xs font-semibold text-white mb-0.5">{step.title}</p>
              <p className="text-[11px] text-[#8892a4] leading-relaxed">{step.desc}</p>
              {i < steps.length - 1 && (
        ...
        <Link
          href="/login"
          className="group relative inline-flex items-center gap-2 bg-gradient-to-r from-[#d97706] to-[#92400e] text-white px-7 py-3 rounded-xl font-semibold text-sm shadow-lg shadow-[#b45309]/15 hover:shadow-[#b45309]/25 hover:brightness-105 transition-all duration-200 overflow-hidden"
        >
